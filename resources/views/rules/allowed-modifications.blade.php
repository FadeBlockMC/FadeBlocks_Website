    ...
    <div class="container mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <aside class="bg-gray-800 p-4 shadow-md rounded-lg md:col-span-1">
            ...
            <nav class="space-y-2">
                ...
                <a href="/rules/forum" class="block text-gray-400 hover:text-indigo-300">Forum Rules</a>
                <a href="/rules/allowed-modifications" class="block text-indigo-400 font-bold hover:text-indigo-300">Allowed Modifications</a>
            </nav>
        </aside>

        <!-- Main Content -->
        <main class="bg-gray-800 p-6 shadow-md rounded-lg md:col-span-3">
            <h1 class="text-3xl font-bold mb-2 text-yellow-400">allowed-modifications</h1>
